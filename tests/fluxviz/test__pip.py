...
from fluxviz         import _pip
from fluxviz._compat import string_types

def test_imports():
    from fluxviz._pip import (
...
def test_call(tmpdir):
    ...
    _pip.call("install", "fluxviz")
    assert_pip_call(_pip.call("install", "fluxviz", quiet = True))
    
    _pip.call("install", "fluxviz", log = path)
