...
from fluxviz              import __name__ as NAME, __version__
from fluxviz.util.system  import pardir, makedirs, touch
...
from fluxviz._compat      import iteritems, configparser as cp
