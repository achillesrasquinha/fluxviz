require.config({
  ...
  paths: {
    ccNetViz: "ccNetViz",
    Combinatorics:
      "https://cdn.jsdelivr.net/npm/js-combinatorics@0.5.5/combinatorics.min",
    randomColor:
      "https://cdnjs.cloudflare.com/ajax/libs/randomcolor/0.5.4/randomColor.min",
    deepmerge: "https://unpkg.com/deepmerge@4.2.2/dist/umd"
  }
});

require(["ccNetViz", "Combinatorics", "randomColor", "deepmerge"], function(
  ccNetViz,
  Combinatorics,
  randomColor,
  deepmerge
