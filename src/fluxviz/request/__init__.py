...
from fluxviz.request.response import Response
from fluxviz.util.string      import safe_encode
from fluxviz.log              import get_logger

logger = get_logger()

# YAGNI: This patched "requests" works only for fluxviz's use-cases.
