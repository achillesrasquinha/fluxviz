...
from fluxviz.model         	import Registry
...
from fluxviz 		      	import (_pip, cli, semver,
	log, parallel
)
...
def get_registry_from_pip(pip_path, user = False, sync = False, outdated = True,
	...
	# _pip.get_installed_distributions() # https://github.com/achillesrasquinha/fluxviz/issues/13
